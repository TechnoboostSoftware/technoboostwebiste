...
function allProject(){
    $(".websiteDisplay").removeClass("d-none")
    $(".mobileDisplay").removeClass("d-none")
    $(".mobileDisplay").removeClass("activeBtn")
    $(".websiteDisplay").removeClass("activeBtn")
    $("#allPages").addClass("activeBtn")
    $("#mobileProject").removeClass("activeBtn")
